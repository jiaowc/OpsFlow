...
public class ServiceController {
     ...
     */
    @GetMapping("/git/refs")
    public List<String> listGitRefs(@RequestParam String gitRepo, @RequestParam(defaultValue = "branch") String type) {
        return serviceGitRefService.listRefs(gitRepo, type);
    }
